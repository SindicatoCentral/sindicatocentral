            ...
            <tr>
              <td style="padding:28px 40px;">
                <p style="font-size:14px;color:#444;margin:0 0 20px;">
                  Los siguientes socios cumplen años hoy.</p>
                ...
                <div style="margin-top:20px;padding:12px 16px;background:#fff8e1;
                  ...
                  ⚠️ Antes de gestionar la gift card, recuerda verificar la
                  antigüedad del socio como afiliado y que esté al día en el
